...
const Hero = () => {
  return (
    <div className="bg-white h-[calc(100vh-3rem)] w-full flex flex-col lg:flex-row gap-6 shadow-md">
      <div className="h-1/2 lg:h-full lg:w-1/2 flex justify-center item-center">
        <div className="flex w-[500px] h-full justify-center items-center flex-col lg:mr-0 lg:ml-auto">
          <div className="text-[64px] font-[900] font-display tracking-[-5px] leading-tight">
